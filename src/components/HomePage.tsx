  ...
  return (
    <div className="flex min-h-screen bg-brand-bg text-brand-text font-sans">
      ...
      <aside className="hidden lg:flex flex-col w-72 bg-brand-surface border-r border-brand-border px-6 py-8 fixed h-full z-50">
        ...
        <Link href="/access" className="mt-8 px-4 py-3 bg-brand-accent text-brand-bg rounded-lg text-sm font-bold text-center hover:opacity-90 transition-all shadow-lg shadow-brand-accent/20">
      ...
      <main className="flex-1 lg:ml-72 bg-brand-bg">
        ...
        <nav className="lg:hidden flex items-center justify-between px-6 py-4 border-b border-brand-border bg-brand-surface/80 backdrop-blur-md sticky top-0 z-50">
          ...
          <Link href="/access" className="px-4 py-2 bg-brand-accent text-brand-bg rounded-lg text-xs font-bold shadow-sm shadow-brand-accent/20">
            Access
          </Link>
        </nav>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link href="/access" className="group px-8 py-4 bg-brand-accent text-brand-bg rounded-xl font-bold flex items-center gap-2 hover:opacity-90 transition-all">
                  Launch Dashboard
